...
*/
        ...
        //拼接orders表的地址
        String addess = addressBook.getProvinceName()+ addressBook.getCityName() + addressBook.getDistrictName() +addressBook.getDetail();
        orders.setAddress(addess);
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        Map map = new HashMap();
        map.put("type",1); //理论 1来单提醒 2催单

        //根据订单号查询订单id 然后赋值
        Long orderId = orderMapper.selectByNumber(ordersPaymentDTO.getOrderNumber());
